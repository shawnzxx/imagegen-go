...
import (
	...
	"github.com/shawnzxx/imagegen-go/pkg/openai"
)
...
func main() {
	...
	for {
		...
		// Client sends initialized notification -> Server acknowledges internally
		...
		case "notifications/initialized", "initialized":
			...
			continue // Skip sending response for notifications, because notifications don’t expect responses

		case "tools/list":
			// 	{
			// 		"prompt": string      // Required: The description of the image to generate
			// 		"width": number      // Optional: Defaults to 512
			// 		"height": number     // Optional: Defaults to 512
			// 		"destination": string // Required: Where to save the image
			// }
